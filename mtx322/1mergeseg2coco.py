'''
@Description: the function of this script is to put test_result_json into test_coco_json.
@author: lijianqing
...
class MergeTestResult2coco(object):
    def __init__(self,test_result_json,test_coco_json,save_path='./260_test1225.json'):
        ...
        coco_data['annotations'] = self.parse_para(test_result_json) # 将test_result_json的内容写入coco_data['annotations']中
